...
class KorHateDataModule(LightningDataModule):
    def __init__(
        self,
    ...
    def load_data(self, path, mode):
        ...
        if mode in ["train", "val", "test"]:
            ...
            return KorHateDataset(encodings=tokenized_sentences, labels=labels)
        else:
            return KorHateDataset(encodings=tokenized_sentences, labels=None)
